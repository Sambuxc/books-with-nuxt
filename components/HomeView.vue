    ...
    <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
      ...
      <div class="mt-8 bg-white overflow-hidden shadow sm:rounded-lg p-6">
        <h2 class="text-2xl leading-7 font-semibold">
          Welcome to Books with Nuxt
        </h2>
        <p class="mt-3 text-gray-600">
          This is an app that I am continually improving and adding content to. It contains key points that I find interesting, useful, insightful and educational from books that I read. It keeps take of key people that are mentioned and draws cross correlational information if these people are mentioned in different books.
        </p>
        <p class="mt-4 pt-4 text-gray-800 border-t border-dashed">
          I hope you find this information useful too. Have fun exploring!
        </p>
      </div>
      <div class="flex justify-center pt-4 space-x-2">
        <a href="https://github.com/sambuxc/books-with-nuxt" target="_blank"><svg
        ...
        <a href="https://www.linkedin.com/in/sam-bruton/" target="_blank"><svg
